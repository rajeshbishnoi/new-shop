										...
										<ul class="dropdown-menu multi-column columns-3">
											<div class="row">
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu1</h6>
														<li><a href="{{url('/products1')}}">Clothing</a></li>
														<li><a href="{{url('/products1')}}">Wallets</a></li>
														<li><a href="{{url('/products1')}}">Shoes</a></li>
														<li><a href="{{url('/products1')}}">Watches</a></li>
														<li><a href="{{url('/products1')}}"> Underwear </a></li>
														<li><a href="{{url('/products1')}}">Accessories</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
													<ul class="multi-column-dropdown">
														<h6>Submenu2</h6>
														<li><a href="{{url('/products1')}}">Sunglasses</a></li>
														<li><a href="{{url('/products1')}}">Wallets,Bags</a></li>
														<li><a href="{{url('/products1')}}">Footwear</a></li>
														<li><a href="{{url('/products1')}}">Watches</a></li>
														<li><a href="{{url('/products1')}}">Accessories</a></li>
														<li><a href="{{url('/products1')}}">Jewellery</a></li>
													</ul>
												</div>
												<div class="col-sm-3  multi-gd-img">
						...
						<div class="product-agileinfo-grids w3l">
								...
								<div class="top-rates">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('/single')}}"><img class="img-responsive " src="images/r.jpg" alt=""></a>	
										</div>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('/single')}}"><img class="img-responsive " src="images/r1.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('/single')}}"><img class="img-responsive " src="images/r2.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
											<h6 class="best2"><a href="{{url('/single')}}">Lorem ipsum dolor </a></h6>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="{{url('/single')}}"><img class="img-responsive " src="images/r3.jpg" alt=""></a>	
										</div>
										<div class="recent-right">
							...
							<div class="col-md-9 product-agileinfon-grid1 w3l">
								...
								<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
									...
									<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="{{URL::asset('public/images/menu.png')}}"></a></li>
									</ul>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i2.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i1.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i4.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i3.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i6.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i5.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i8.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i7.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i10.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i9.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i12.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i11.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
													...
													<div class="grid-arr">
														<div  class="grid-arrival">
															<figure>		
																<a href="#" class="new-gri" data-toggle="modal" data-target="#myModal1">
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i14.jpg')}}" class="img-responsive" alt="">
																	</div>
																	<div class="grid-img">
																		<img  src="{{URL::asset('public/images/i13.jpg')}}" class="img-responsive"  alt="">
																	</div>			
																</a>		
															</figure>	
														</div>
