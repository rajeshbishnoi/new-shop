...
<link href='//fonts.googleapis.com/css?family=Open+Sans:400,800italic,800,700italic,700,600italic,600,400italic,300italic,300's rel='stylesheet' type='text/css'>
<!--search jQuery-->
				...
				<div class="form-w3agile form1">
					...
					<form action="#" method="post">
						...
						<div class="key">
							...
							{!! Form::text('email','', array('class' => '','placeholder' => '' )) !!}
							<div class="clearfix"></div>
						</div>
						<div class="key">
